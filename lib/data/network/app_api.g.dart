...
class _AppServiceClient implements AppServiceClient {
  _AppServiceClient(
    ...
    baseUrl ??= 'https://659d4.wiremockapi.cloud/';
  }
  ...
  @override
  Future<SupportForgotPasswordResponse> forgotPassword(String email) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'email': email};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SupportForgotPasswordResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SupportForgotPasswordResponse.fromJson(_result.data!);
    return value;
  }
