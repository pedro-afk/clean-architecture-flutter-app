...
SupportForgotPasswordResponse _$SupportForgotPasswordResponseFromJson(
        Map<String, dynamic> json) =>
    SupportForgotPasswordResponse(
      json['support'] as String?,
    )
      ..status = json['status'] as int?
      ..message = json['message'] as String?;

Map<String, dynamic> _$SupportForgotPasswordResponseToJson(
        SupportForgotPasswordResponse instance) =>
    <String, dynamic>{
      'status': instance.status,
      'message': instance.message,
